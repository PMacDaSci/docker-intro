...
- The lessons will sometimes request that you use a text editor to create or edit files in particular directories. It is assumed that you either have an editor that you know how to use that runs within the working directory of your shell window (e.g. `nano`), or that if you use a graphical editor, that you can use it to read and write files into the working directory of your shell. We recommend [Visual Studio Code (VS Code)](https://code.visualstudio.com/download) as an IDE and text editor for this workshop.
...
```{=html}
<details>
<summary style="font-weight: 600;" >Apple macOS</summary>
```
